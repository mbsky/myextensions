...
namespace MyExtensions.Web.Security
{
    ...
    public sealed class SimpleSqlProfileProvider : ProfileProvider {
        ...
        private const string keyColumnName = "UserName";

        private const string lastUpdateColumnName = "lastUpdate";
        ...
        public override void Initialize(string name, System.Collections.Specialized.NameValueCollection config) {
            ...
            if (String.IsNullOrEmpty(config["description"])) {
                ...
                config.Add("description", "linlang profile provider");
            }
            ...
            using (DataTable dt = new DataTable()) {
                ...
                foreach (SettingsProperty prop in collection) {
                    ...
                    if (dt.Rows.Count == 0) {
                        ...
                        string columnName = GetPropertyMapInfo(prop).ColumnName;
                        if (dt.Columns.IndexOf(columnName) == -1) throw new ProviderException(string.Format("Column '{0}' required for property '{1}' was not found in table '{2}'.", columnName, prop.Name, tableName));
